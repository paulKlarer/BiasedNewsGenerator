...
import datetime
"""
#Ist credentials storen notwendig hier???
from dotenv import load_dotenv
...
#statt admin hier noch os.getenv('DB_USER')?
MONGODB_URI = os.getenv("MONGODB_URI", "mongodb+srv://admin:<encoded_password>@softwareengineering.lgyhy.mongodb.net/?retryWrites=true&w=majority&appName=SoftwareEngineering")
DB_NAME = "my_database"
COLLECTION_NAME = "ML_AI"

###API Yonis?
FINETUNED_MODEL_API_BASE = "http://api.myfinetunedmodel.com"  # placeholder
FINETUNED_MODEL_API_TOKEN = os.getenv("FINETUNED_MODEL_API_TOKEN", "mock_token")

EVALUATOR_MODEL_API_BASE = "http://api.mythirdpartyevaluator.com"  # placeholder
EVALUATOR_MODEL_API_TOKEN = os.getenv("EVALUATOR_MODEL_API_TOKEN", "mock_eval_token")"
"""
